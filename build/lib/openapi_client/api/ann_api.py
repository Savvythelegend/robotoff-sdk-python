...
class ANNApi:
    ...
    def ann_search_get(
        self,
        count: Annotated[Optional[Annotated[int, Field(le=2000, strict=True, ge=1)]], Field(description="Number of neighbors to return")] = None,
        ...
        _param = self._ann_search_get_serialize(
            count=count,
    ...
    @validate_call
    def ann_search_get_with_http_info(
        self,
        count: Annotated[Optional[Annotated[int, Field(le=2000, strict=True, ge=1)]], Field(description="Number of neighbors to return")] = None,
        server_type: Annotated[Optional[StrictStr], Field(description="The server type (=project) to use, such as 'off' (Open Food Facts), 'obf' (Open Beauty Facts),...")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LogoANNSearchResponse]:
        """Approximate search for nearest neighbors of a random query logo
    ...
    @validate_call
    def ann_search_get_without_preload_content(
        self,
        count: Annotated[Optional[Annotated[int, Field(le=2000, strict=True, ge=1)]], Field(description="Number of neighbors to return")] = None,
        server_type: Annotated[Optional[StrictStr], Field(description="The server type (=project) to use, such as 'off' (Open Food Facts), 'obf' (Open Beauty Facts),...")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def ann_search_logo_id_int_get(
        self,
        count: Annotated[Optional[Annotated[int, Field(le=2000, strict=True, ge=1)]], Field(description="Number of neighbors to return")] = None,
        server_type: Annotated[Optional[StrictStr], Field(description="The server type (=project) to use, such as 'off' (Open Food Facts), 'obf' (Open Beauty Facts),...")] = None,
        _request_timeout: Union[
        ...
        _param = self._ann_search_logo_id_int_get_serialize(
            count=count,
            server_type=server_type,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def ann_search_logo_id_int_get_with_http_info(
        self,
        count: Annotated[Optional[Annotated[int, Field(le=2000, strict=True, ge=1)]], Field(description="Number of neighbors to return")] = None,
        server_type: Annotated[Optional[StrictStr], Field(description="The server type (=project) to use, such as 'off' (Open Food Facts), 'obf' (Open Beauty Facts),...")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def ann_search_logo_id_int_get_without_preload_content(
        self,
        count: Annotated[Optional[Annotated[int, Field(le=2000, strict=True, ge=1)]], Field(description="Number of neighbors to return")] = None,
        server_type: Annotated[Optional[StrictStr], Field(description="The server type (=project) to use, such as 'off' (Open Food Facts), 'obf' (Open Beauty Facts),...")] = None,
        _request_timeout: Union[
    ...
    def _ann_search_logo_id_int_get_serialize(
        self,
        count,
        server_type,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ann/search/{logo_id:int}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
