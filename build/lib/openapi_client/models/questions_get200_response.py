...
class QuestionsGet200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status", "questions", "count"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['no_questions', 'found']):
            raise ValueError("must be one of enum values ('no_questions', 'found')")
        return value
