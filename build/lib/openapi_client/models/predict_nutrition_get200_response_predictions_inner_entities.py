...
class PredictNutritionGet200ResponsePredictionsInnerEntities(BaseModel):
    """
    PredictNutritionGet200ResponsePredictionsInnerEntities
    """ # noqa: E501
    aggregated: Optional[List[Dict[str, Any]]] = None
    postprocessed: Optional[List[Dict[str, Any]]] = None
    raw: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["aggregated", "postprocessed", "raw"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "postprocessed": obj.get("postprocessed"),
            "raw": obj.get("raw")
        })
        return _obj
