...
class PredictCategoryPost200Response(BaseModel):
    """
    PredictCategoryPost200Response
    """ # noqa: E501
    neural: Optional[List[PredictCategoryPost200ResponseNeuralInner]] = None
    __properties: ClassVar[List[str]] = ["neural"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in neural (list)
        _items = []
        if self.neural:
            for _item_neural in self.neural:
                if _item_neural:
                    _items.append(_item_neural.to_dict())
            _dict['neural'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "neural": [PredictCategoryPost200ResponseNeuralInner.from_dict(_item) for _item in obj["neural"]] if obj.get("neural") is not None else None
        })
        return _obj
