...
class PredictLangGet200ResponsePredictionsInner(BaseModel):
    """
    PredictLangGet200ResponsePredictionsInner
    """ # noqa: E501
    lang: Optional[StrictStr] = Field(default=None, description="the predicted language (2-letter code)")
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="the probability of the predicted language")
    __properties: ClassVar[List[str]] = ["lang", "confidence"]
