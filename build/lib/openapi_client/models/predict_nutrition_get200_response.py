...
class PredictNutritionGet200Response(BaseModel):
    """
    the extracted nutritional information from the model. 
    """ # noqa: E501
    predictions: Optional[List[PredictNutritionGet200ResponsePredictionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "predictions": [PredictNutritionGet200ResponsePredictionsInner.from_dict(_item) for _item in obj["predictions"]] if obj.get("predictions") is not None else None
        })
        return _obj
