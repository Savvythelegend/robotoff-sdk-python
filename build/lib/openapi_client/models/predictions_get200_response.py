...
class PredictionsGet200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status", "predictions", "count"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['no_predictions', 'found']):
            raise ValueError("must be one of enum values ('no_predictions', 'found')")
        return value
