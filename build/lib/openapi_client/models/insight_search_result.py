...
class InsightSearchResult(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Insight ID")
    type: StrictStr = Field(description="Insight type")
    barcode: StrictInt = Field(description="Barcode of the product")
    countries: List[StrictStr] = Field(description="country tags of the product")
    __properties: ClassVar[List[str]] = ["id", "type", "barcode", "countries"]
