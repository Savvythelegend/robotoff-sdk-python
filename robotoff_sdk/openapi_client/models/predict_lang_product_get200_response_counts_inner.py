...
class PredictLangProductGet200ResponseCountsInner(BaseModel):
    """
    ...
    count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="the number of words for which this language was detected over all images")
    __properties: ClassVar[List[str]] = ["lang", "count"]
