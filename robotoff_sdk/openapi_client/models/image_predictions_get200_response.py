...
class ImagePredictionsGet200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status", "image_predictions", "count"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['no_image_predictions', 'found']):
            raise ValueError("must be one of enum values ('no_image_predictions', 'found')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "image_predictions": obj.get("image_predictions"),
            "count": obj.get("count")
        })
        return _obj
