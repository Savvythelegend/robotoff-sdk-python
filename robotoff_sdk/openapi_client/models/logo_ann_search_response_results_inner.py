...
class LogoANNSearchResponseResultsInner(BaseModel):
    """
    LogoANNSearchResponseResultsInner
    """ # noqa: E501
    logo_id: StrictInt = Field(description="ID of the result logo")
    distance: Union[StrictFloat, StrictInt] = Field(description="distance between the query logo and the result logo (closer to 0 means a more similar logo) ")
    __properties: ClassVar[List[str]] = ["logo_id", "distance"]
