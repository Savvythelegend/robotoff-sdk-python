...
class ImagesLogosGet200Response(BaseModel):
    """
    ImagesLogosGet200Response
    """ # noqa: E501
    logos: List[StrictStr] = Field(description="Details about requested logos")
    count: Union[StrictFloat, StrictInt] = Field(description="Number of returned results")
    __properties: ClassVar[List[str]] = ["logos", "count"]
