...
class InsightsGet200Response(BaseModel):
    """
    InsightsGet200Response
    """ # noqa: E501
    insights: Optional[List[InsightSearchResult]] = None
    status: Optional[StrictStr] = None
    count: Optional[StrictInt] = Field(default=None, description="The total number of results with the provided filters")
    __properties: ClassVar[List[str]] = ["insights", "status", "count"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['no_insights', 'found']):
            raise ValueError("must be one of enum values ('no_insights', 'found')")
        return value
