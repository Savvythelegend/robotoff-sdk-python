...
class PredictCategoryPost200ResponseNeuralInner(BaseModel):
    """
    PredictCategoryPost200ResponseNeuralInner
    """ # noqa: E501
    value_tag: StrictStr = Field(description="The predicted `value_tag`")
    confidence: Union[StrictFloat, StrictInt] = Field(description="The confidence score of the model")
    __properties: ClassVar[List[str]] = ["value_tag", "confidence"]
