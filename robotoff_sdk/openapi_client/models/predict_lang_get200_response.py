...
class PredictLangGet200Response(BaseModel):
    """
    PredictLangGet200Response
    """ # noqa: E501
    predictions: Optional[List[PredictLangGet200ResponsePredictionsInner]] = Field(default=None, description="a list of predicted languages, sorted by descending probability")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "predictions": [PredictLangGet200ResponsePredictionsInner.from_dict(_item) for _item in obj["predictions"]] if obj.get("predictions") is not None else None
        })
        return _obj
